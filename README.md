MRDA Rankings Algorithm using Linear Regression on Score Ratios
===============
## [Unoffical MRDA Rankings Algorithm Tool for Score Ratios](https://grimesbot.github.io/MRDA-Rankings-LRR)
...
This implementation for the MRDA was inspired by the [WFTDA's 2025 Rankings Algorithm](https://docs.google.com/document/d/e/2PACX-1vS2Va64tTxNligHExRfUGgzEkn4wO8RM5-3Q5J6I3aeuuvCwP-SzfTEnqifJrWWZSXPplKEqeFrEYNs/pub). This implementation is different in a number of key ways to fit the specific needs of the MRDA, mostly regarding seasonality, regionality and inevitable greater competative disparity with significantly fewer teams. However, WFTDA's documentation is very informative and incredibly useful in explaining and understanding the underlying mathematics. Thank you to the WFTDA for their amazing work on sports rating algorithms for flat track roller derby.
